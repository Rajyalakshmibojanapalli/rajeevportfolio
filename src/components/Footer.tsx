            ...
            <div className="flex flex-col lg:flex-row justify-between w-full max-w-[1298px] h-auto lg:h-[239px] gap-8 lg:gap-0 mt-8 md:mt-0">
                ...
                <div className="w-full lg:w-[635px] h-full flex flex-col items-start justify-start gap-6 lg:gap-10">
                    <div className="flex gap-3 sm:gap-4 items-center flex-shrink-0 cursor-pointer">
                        ...
                        <span className="font-bold text-base sm:text-lg tracking-wide cursor-pointer">Rajeev</span>
                    </div>
                    <p className="w-full h-auto lg:h-[61px] text-[16px] sm:text-[18px] lg:text-[20px] text-[#FCFCFD]"> From SEO and content marketing to social media management and PPC campaigns, our team of experts delivers measurable results and ROI-focused strategies. 
                    </p>
